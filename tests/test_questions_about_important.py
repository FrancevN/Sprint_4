...
def test_questions_about_important_questions_1(driver):
    ask_text = main_page.questions_1_scroll_and_click(driver)
...
def test_questions_about_important_questions_2(driver):
    ask_text = main_page.questions_2_scroll_and_click(driver)
...
def test_questions_about_important_questions_3(driver):
    ask_text = main_page.questions_3_scroll_and_click(driver)
...
def test_questions_about_important_questions_4(driver):
    ask_text = main_page.questions_4_scroll_and_click(driver)
...
def test_questions_about_important_questions_5(driver):
    ask_text = main_page.questions_5_scroll_and_click(driver)
...
def test_questions_about_important_questions_6(driver):
    ask_text = main_page.questions_6_scroll_and_click(driver)
...
def test_questions_about_important_questions_7(driver):
    ask_text = main_page.questions_7_scroll_and_click(driver)
...
def test_questions_about_important_questions_8(driver):
    ask_text = main_page.questions_8_scroll_and_click(driver)
